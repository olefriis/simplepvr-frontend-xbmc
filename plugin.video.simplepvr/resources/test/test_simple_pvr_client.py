...
class TestSimplePvrClient:
	...
	def test_can_get_information_on_recordings(self):
		...
		self.get_response = """[
			{"id":"1","show_id":"The Man Who Wasnt There","subtitle":"Amerikansk krimidrama fra 2001.","description":"Ed passer sin daglige dont i fris\u00f8rsalonen i 1949, hvor der stadig var sort-hvide film og livsfarlige blondiner. Da en skaldet handelsrejsende kommer forbi med en fidus, ser Ed sit livs chance. Han afpresser Big Dave, som hans kone Doris har en aff\u00e6re med. Planen ser skudsikker ud, men det eneste, der er sikkert, er, at nogen bliver skudt. Og nogen ender i stolen for mord.","start_time":"2013-04-20T21:28:00+02:00","channel_name":"DR K","has_thumbnail":false,"has_icon":false,"has_webm":false,"local_file_url":"file:///data/simplePVR/simplepvr/recordings/The Man Who Wasnt There/1/stream.ts"},
			{"id":"2","show_id":"The Man Who Was There","subtitle":"Oh well...","description":"Just a 2nd recording for test purposes...","start_time":"2013-04-25T05:35:00+02:00","channel_name":"DR 1","has_thumbnail":false,"has_icon":false,"has_webm":false,"local_file_url":"file:///data/simplePVR/simplepvr/recordings/The Man Who Was There/2/stream.ts"}
			]"""
		...
		assert recordings[0].icon_url == None

	def test_handles_missing_icon_information_from_server(self):
		client = SimplePvrClient('http://my-site.com:4567', '', '')
		client.get = self.fake_get
		self.expected_url = 'http://my-site.com:4567/api/shows/The%20Man%20Who%20Wasnt%20There/recordings'
		self.get_response = """[
	...
	def test_knows_when_recording_has_icon(self):
		client = SimplePvrClient('http://my-site.com:4567', '', '')
		client.get = self.fake_get
		self.expected_url = 'http://my-site.com:4567/api/shows/The%20Man%20Who%20Wasnt%20There/recordings'
		self.get_response = """[
			{"id":"123456","show_id":"The Man Who Wasnt There","subtitle":"Amerikansk krimidrama fra 2001.","description":"Ed passer sin daglige dont i fris\u00f8rsalonen i 1949.","start_time":"2013-04-20T21:28:00+02:00","channel_name":"DR K","has_thumbnail":false,"has_icon":true,"has_webm":false,"local_file_url":"file:///data/simplePVR/simplepvr/recordings/The Man Who Wasnt There/1/stream.ts"}
			]"""

		recordings = client.recordings_of_show('The Man Who Wasnt There')
		assert recordings[0].id == '123456'
		assert recordings[0].icon_url == 'http://my-site.com:4567/api/shows/The%20Man%20Who%20Wasnt%20There/recordings/123456/icon'
	...
	def test_gives_local_file_url_for_recordings_when_on_same_machine(self):
		...
		self.expected_url = 'http://my-site.com:4567/api/shows/The%20Man%20Who%20Wasnt%20There/recordings'
		self.get_response = """[
			{"id":"1","show_id":"The Man Who Wasnt There","subtitle":"Amerikansk krimidrama fra 2001.","description":"Ed passer sin daglige dont i fris\u00f8rsalonen i 1949, hvor der stadig var sort-hvide film og livsfarlige blondiner. Da en skaldet handelsrejsende kommer forbi med en fidus, ser Ed sit livs chance. Han afpresser Big Dave, som hans kone Doris har en aff\u00e6re med. Planen ser skudsikker ud, men det eneste, der er sikkert, er, at nogen bliver skudt. Og nogen ender i stolen for mord.","start_time":"2013-04-20T21:28:00+02:00","channel_name":"DR K","has_icon":false,"has_thumbnail":false,"has_webm":false,"local_file_url":"file:///data/simplePVR/simplepvr/recordings/The Man Who Wasnt There/1/stream.ts"}
			]"""
	...
	def test_can_construct_video_url_with_username_and_password(self):
		...
		self.expected_url = 'http://my-site.com:4567/api/shows/The%20Man%20Who%20Wasnt%20There/recordings'
		self.get_response = """[
			{"id":"4","show_id":"The Man Who Wasnt There","episode":"1","subtitle":"Amerikansk krimidrama fra 2001.","description":"Ed passer sin daglige dont i fris\u00f8rsalonen i 1949, hvor der stadig var sort-hvide film og livsfarlige blondiner. Da en skaldet handelsrejsende kommer forbi med en fidus, ser Ed sit livs chance. Han afpresser Big Dave, som hans kone Doris har en aff\u00e6re med. Planen ser skudsikker ud, men det eneste, der er sikkert, er, at nogen bliver skudt. Og nogen ender i stolen for mord.","start_time":"2013-04-20T21:28:00+02:00","channel_name":"DR K","has_icon":false,"has_icon":false,"has_thumbnail":false,"has_webm":false,"local_file_url":"file:///data/simplePVR/simplepvr/recordings/The Man Who Wasnt There/1/stream.ts"}
			]"""
